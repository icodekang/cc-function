  ...
  Functions.prototype = {
    ...
    pushState: function () {
      if (window.history && window.history.pushState)
        this.query ? history.pushState({}, "cc_functions", "#!kw=" + this.query) :
          history.pushState({}, "cc_functions", window.location.pathname);
    },
    //简单模版
    ...
    searchResult: function (islist) {
      var arr = this.functions, self = this, i = 0,
